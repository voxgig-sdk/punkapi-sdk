# Punkapi SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions PunkapiSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both PunkapiSDK(...) and PunkapiSDK.test(...) become
#      PunkapiSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "punkapi_sdk"
_SDK_CLASS = "PunkapiSDK"
