...
from punkapi_sdk.utility import register

# Load features
from punkapi_sdk.feature.base_feature import PunkapiBaseFeature
from punkapi_sdk.features import _has_feature, _make_feature
...
class PunkapiSDK:
    ...
    def get_utility(self):
        return PunkapiUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("PunkapiSDK: graphql: " + str(msg))
            res["graphql"] = errors
