...
func (sdk *PunkapiSDK) OptionsMap() map[string]any {
...
func (sdk *PunkapiSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *PunkapiSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *PunkapiSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *PunkapiSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *PunkapiSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *PunkapiSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("PunkapiSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *PunkapiSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *PunkapiSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("PunkapiSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
