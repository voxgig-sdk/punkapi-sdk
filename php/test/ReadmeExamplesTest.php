...
// Punkapi SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (PunkapiSDK::test)
...
{
    private const SDK_CLASS = 'PunkapiSDK';
    ...
    private const SDK_BASE = 'punkapi_sdk';
