...
class PunkapiTestRunner
{
    ...
    {
        $live = self::getenv('PUNKAPI_TEST_LIVE');
        $override = self::getenv('PUNKAPI_TEST_OVERRIDE');
        ...
        $explain = self::getenv('PUNKAPI_TEST_EXPLAIN');
...
class_alias('PunkapiTestRunner', 'Runner');
class_alias('PunkapiHelpers', 'Helpers');
