...
{
    private static function utility(): PunkapiUtility
    {
        return new PunkapiUtility();
    }
    ...
    private static function ctx(array $over = []): PunkapiContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new PunkapiContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new PunkapiOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof PunkapiError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new PunkapiOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = PunkapiMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new PunkapiOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = PunkapiMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new PunkapiOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = PunkapiMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new PunkapiSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = PunkapiMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new PunkapiResponse([]),
            'result' => new PunkapiResult([]),
        ]);
        [, $err] = PunkapiMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new PunkapiSpec([]),
            'response' => null,
            'result' => new PunkapiResult([]),
        ]);
        [, $err] = PunkapiMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new PunkapiSpec(['step' => 's']),
            'response' => new PunkapiResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new PunkapiResult([]),
        ]);
        [, $err] = PunkapiMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new PunkapiSpec(['step' => 's']),
            'response' => new PunkapiResponse(self::resp(200, ['v' => 1])),
            'result' => new PunkapiResult([]),
        ]);
        [, $err] = PunkapiMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new PunkapiSpec(['step' => 's']),
            'response' => new PunkapiResponse(self::resp(200, ['v' => 2])),
            'result' => new PunkapiResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        PunkapiMakeResponse::call($ctx);
    ...
    {
        $preset = new PunkapiResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new PunkapiSpec([]),
            'response' => new PunkapiResponse([]),
            'result' => new PunkapiResult([]),
        ...
        [$got, $err] = PunkapiMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new PunkapiResult([])]);
        [, $err] = PunkapiMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new PunkapiSpec([]), 'result' => null]);
        [, $err] = PunkapiMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new PunkapiSpec(['step' => 's']),
            'result' => new PunkapiResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new PunkapiOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = PunkapiMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new PunkapiSpec(['step' => 's']),
            'result' => new PunkapiResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new PunkapiOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = PunkapiMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new PunkapiResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new PunkapiSpec([]),
            'result' => new PunkapiResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = PunkapiMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = PunkapiMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new PunkapiError('boom', 'boom');
        $utility->fetcher = function (PunkapiContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new PunkapiSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = PunkapiMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (PunkapiContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = PunkapiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(PunkapiResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (PunkapiContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new PunkapiSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = PunkapiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new PunkapiResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new PunkapiSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = PunkapiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = PunkapiMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = PunkapiMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new PunkapiResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, PunkapiDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new PunkapiResult(['ok' => false])]);
        $this->expectException(PunkapiError::class);
        PunkapiDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new PunkapiResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', PunkapiMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        PunkapiMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new PunkapiBaseFeature();
        $b = new PunkapiBaseFeature();
        PunkapiFeatureAdd::call($ctx, $a);
        PunkapiFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): PunkapiBaseFeature
    {
        $f = new PunkapiBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        PunkapiFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): PunkapiContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new PunkapiSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = PunkapiPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new PunkapiResponse(['headers' => null]),
            'result' => new PunkapiResult([]),
        ]);
        PunkapiResultHeaders::call($ctx);
