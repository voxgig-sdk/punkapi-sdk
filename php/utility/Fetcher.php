...
// Punkapi SDK utility: fetcher

class PunkapiFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; PunkapiSDK/1.0)';
    ...
    public static function call(PunkapiContext $ctx, string $fullurl, array $fetchdef): array
    {
