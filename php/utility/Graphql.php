...
class PunkapiGraphql
{
    ...
    // equivalent.
    public static function body(PunkapiContext $ctx): mixed
    {
    ...
    public static function errors(PunkapiContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
