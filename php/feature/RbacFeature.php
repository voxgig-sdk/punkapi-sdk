...
class PunkapiRbacFeature extends PunkapiBaseFeature
{
    ...
    private function _required(PunkapiContext $ctx): ?string
    {
    ...
    private function _reject(PunkapiContext $ctx, string $required): void
    {
    ...
    private function _track(PunkapiContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
