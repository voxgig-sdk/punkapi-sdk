...
class PunkapiTimeoutFeature extends PunkapiBaseFeature
{
    ...
    private function _with_timeout(PunkapiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(PunkapiContext $_ctx, float $ms): void
    {
        $client = $this->client;
