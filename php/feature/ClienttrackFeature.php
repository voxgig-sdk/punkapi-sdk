...
// Punkapi SDK clienttrack feature
...
class PunkapiClienttrackFeature extends PunkapiBaseFeature
{
    ...
    public function PostConstruct(PunkapiContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Punkapi-SDK';
