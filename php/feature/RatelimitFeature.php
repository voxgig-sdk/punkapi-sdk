...
class PunkapiRatelimitFeature extends PunkapiBaseFeature
{
    ...
    private function _acquire(PunkapiContext $ctx): void
    {
    ...
    private function _track(PunkapiContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
