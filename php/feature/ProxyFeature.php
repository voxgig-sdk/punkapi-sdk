...
class PunkapiProxyFeature extends PunkapiBaseFeature
{
    ...
    public function init(PunkapiContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (PunkapiContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
