...
class PunkapiStreamingFeature extends PunkapiBaseFeature
{
    ...
    private function _iterate(PunkapiResult $result): \Generator
    {
    ...
    private function _streamable(PunkapiContext $ctx): bool
    {
