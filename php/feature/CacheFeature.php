...
class PunkapiCacheFeature extends PunkapiBaseFeature
{
    ...
    private function _through(PunkapiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
