...
(0, node_test_1.describe)('BeerDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-beer', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-beer', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-beer', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-beer', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function liveScenariosActive() { return false && process.env.PUNKAPI_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.PunkapiSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['PUNKAPI_TEST_BEER_ENTID'];
    ...
    const client = new __1.PunkapiSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=BeerDirect.test.js.map