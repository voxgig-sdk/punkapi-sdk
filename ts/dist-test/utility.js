...
function envOverride(m) {
    if ('TRUE' === process.env.PUNKAPI_TEST_LIVE ||
        'TRUE' === process.env.PUNKAPI_TEST_OVERRIDE) {
    ...
    m.PUNKAPI_TEST_EXPLAIN = process.env.PUNKAPI_TEST_EXPLAIN || m.PUNKAPI_TEST_EXPLAIN;
    return m;
}
