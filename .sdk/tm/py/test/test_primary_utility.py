...
from projectname_sdk import PunkapiSDK
from projectname_sdk.core.spec import PunkapiSpec
from projectname_sdk.core.result import PunkapiResult
from projectname_sdk.core.response import PunkapiResponse
from projectname_sdk.core.operation import PunkapiOperation
from projectname_sdk.core.error import PunkapiError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import PunkapiBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = PunkapiSDK.test(None, None)
        ...
        class TestInitFeature(PunkapiBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(PunkapiBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = PunkapiSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = PunkapiSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = PunkapiSDK.test(None, setup_opts)
