...
from projectname_sdk.core.control import PunkapiControl
...
class PunkapiContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, PunkapiResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return PunkapiError(code, msg, self)
