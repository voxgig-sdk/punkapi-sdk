...
// Punkapi SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = PunkapiOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(PunkapiOmni::structfix($now, Struct::undef()))
                        !== json_encode(PunkapiOmni::structfix($val, Struct::undef()))) {
