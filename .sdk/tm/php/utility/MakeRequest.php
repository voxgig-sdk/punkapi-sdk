...
// Punkapi SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class PunkapiMakeRequest
{
    public static function call(PunkapiContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new PunkapiResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new PunkapiResponse($fetched);
        } else {
