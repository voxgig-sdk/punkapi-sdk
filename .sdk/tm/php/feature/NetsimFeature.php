...
class PunkapiNetsimFeature extends PunkapiBaseFeature
{
    ...
    private function _simulate(PunkapiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(PunkapiContext $ctx, array $applied): void
    {
        $client = $this->client;
