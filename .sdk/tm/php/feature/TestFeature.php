...
// Punkapi SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class PunkapiTestFeature extends PunkapiBaseFeature
{
    ...
    public function init(PunkapiContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (PunkapiContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (PunkapiContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(PunkapiContext $ctx, $op, $args): array
    {
