...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = PunkapiOmni.make_runner(TEST_JSON_FILE, PunkapiSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : PunkapiOmni.errify(err)
    end
