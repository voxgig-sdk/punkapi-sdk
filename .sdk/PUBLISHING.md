...
|---|---|---|
| `ts/` | @voxgig-sdk/punkapi-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/punkapi-sdk \
      --repository voxgig-sdk/punkapi-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/punkapi-sdk` shows it, and
`npm trust revoke @voxgig-sdk/punkapi-sdk --id=<id>` removes it.
