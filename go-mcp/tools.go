...
type Args struct {
	Entity string         `json:"entity" jsonschema:"beer | image"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.PunkapiSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "punkapi_list",
		Description: "List records from Punkapi. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "punkapi_load",
		Description: "Load a single record from Punkapi. " +
...
func runOp(client *sdk.PunkapiSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.PunkapiSDK, name string) (sdk.PunkapiEntity, error) {
	switch strings.ToLower(name) {
	case "beer":
		return client.Beer(nil), nil
	case "image":
