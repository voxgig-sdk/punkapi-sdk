...
module PunkapiTestRunner
  ...
  def self.env_override(m)
    live = getenv("PUNKAPI_TEST_LIVE")
    override = getenv("PUNKAPI_TEST_OVERRIDE")
    ...
    explain = getenv("PUNKAPI_TEST_EXPLAIN")
    m["PUNKAPI_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = PunkapiTestRunner
Helpers = PunkapiHelpers
Vs = VoxgigStruct
