...
The Ruby SDK for the Punkapi API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `PunkapiError` (a `StandardError` subclass), so wrap
...
```
rb/
├── Punkapi_sdk.rb       -- Main SDK module
