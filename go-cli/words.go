...
func registerSDKWords(r *eng.Registry, client *sdk.PunkapiSDK) {
...
func runOp(client *sdk.PunkapiSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
