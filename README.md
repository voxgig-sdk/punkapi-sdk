...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/punkapi` | `npm install @voxgig-sdk/punkapi` |
| Python | `voxgig-sdk-punkapi` | `pip install voxgig-sdk-punkapi` |
| PHP | `voxgig-sdk/punkapi` | `composer require voxgig-sdk/punkapi` |
| Golang | `github.com/voxgig-sdk/punkapi-sdk/go` | `go get github.com/voxgig-sdk/punkapi-sdk/go` |
| Ruby | `voxgig-sdk-punkapi` | `gem install voxgig-sdk-punkapi` |
| Lua | `voxgig-sdk-punkapi` | `luarocks install voxgig-sdk-punkapi` |
